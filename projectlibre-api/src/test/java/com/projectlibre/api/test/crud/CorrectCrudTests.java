...
/**
 * Correct CRUD tests based on actual API responses
 */
public class CorrectCrudTests {
    ...
    public static void main(String[] args) {
        System.out.println("=================================================");
        System.out.println("     CORRECT COMPREHENSIVE CRUD TESTS");
        System.out.println("=================================================");
    ...
    private static void testBasicCrudOperations() {
        ...
        runTest("CREATE - New resource", () -> {
            ...
            // Resources endpoint returns raw array or error, so check for non-error
        ...
        runTest("READ - All resources", () -> {
            ...
            // Resources endpoint returns raw array
                    ...
                    for (int j = 0; j < requestsPerThread; j++) {
                        try {
                            ...
                            if (response.getBody().contains("\"status\":\"UP\"")) {
                                synchronized (CorrectCrudTests.class) {
                                    successCount[0]++;
                                }
                            }
                        } catch (Exception e) {
