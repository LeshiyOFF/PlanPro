...
public class ProjectConverter {
	...
	public Object convert(String format, Type type, boolean from, Object externalObject, Object projectlibreObject, Object state) throws Exception{
		...
		if (method.getReturnType().equals(Void.TYPE)){
			method.invoke(converterClass.newInstance(), new Object[]{externalObject,projectlibreObject,state});
			result=from?projectlibreObject:externalObject;
		 }
		else result=method.invoke(converterClass.newInstance(), new Object[]{from?externalObject:projectlibreObject,state});
		return result;
	}
