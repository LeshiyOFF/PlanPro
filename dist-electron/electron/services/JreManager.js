...
exports.JreManager = void 0;
const IJreManager_1 = require("./interfaces/IJreManager");
const SystemJreDetector_1 = require("./SystemJreDetector");
const EmbeddedJreService_1 = require("./EmbeddedJreService");
/**
...
class JreManager {
    ...
    maxJavaVersion = '21';
    constructor() {
        this.systemJreDetector = new SystemJreDetector_1.SystemJreDetector();
        this.embeddedJreService = new EmbeddedJreService_1.EmbeddedJreService();
    }
    /**
     ...
     */
    isJavaVersionCompatible(version) {
        try {
    ...
    async getJreType() {
        try {
            ...
            if (embeddedInfo && embeddedInfo.isValid) {
                return IJreManager_1.JreType.EMBEDDED;
            }
            // Проверяем системную Java
            const javaPath = await this.getJavaExecutablePath();
            if (javaPath) {
                return IJreManager_1.JreType.SYSTEM;
            }
     ...
     */
    async findAllJreInstallations() {
        try {
            const jreList = [];
            let recommendedJre = null;
            ...
            if (!recommendedJre) {
                const validSystemJre = systemInstallations
                    ...
                    .sort((a, b) => this.compareVersions(this.normalizeVersion(b.version), this.normalizeVersion(a.version)));
     ...
     */
    async getJavaInstallationRecommendations() {
        const recommendations = [];
        try {
            const jreType = await this.getJreType();
            if (jreType === IJreManager_1.JreType.NONE) {
            ...
            if (!hasEmbedded && jreType === IJreManager_1.JreType.SYSTEM) {
...
exports.JreManager = JreManager;
//# sourceMappingURL=JreManager.js.map