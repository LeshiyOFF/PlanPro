...
exports.SystemJreDetector = void 0;
...
class SystemJreDetector {
     ...
     */
    async findSystemJavaInstallations() {
    ...
    async getJreInfo(javaPath) {
        try {
            ...
            return {
                ...
                type: IJreManager_1.JreType.SYSTEM,
    ...
    async getJavaVersion(javaPath) {
        return new Promise((resolve) => {
            const child = (0, child_process_1.spawn)(javaPath, ['-version'], {
    ...
    getSystemJavaSearchPaths() {
        ...
        if (this.platform === 'win32') {
            ...
            paths.push(path.join(programFiles, 'Java'), path.join(programFilesX86, 'Java'), 'C:\\Java', 'C:\\Program Files\\AdoptOpenJDK', 'C:\\Program Files\\Eclipse Adoptium');
        }
        else if (this.platform === 'darwin') {
            // macOS пути
            paths.push('/Library/Java/JavaVirtualMachines', '/System/Library/Java/JavaVirtualMachines', '/usr/local/opt/openjdk', '/opt/homebrew/opt/openjdk');
        }
        else {
            // Linux пути
            paths.push('/usr/lib/jvm', '/usr/lib64/jvm', '/usr/local/java', '/opt/java', '/usr/lib/jvm/default-java');
        }
        return paths;
    }
    /**
     ...
     */
    async searchJavaInPath(searchPath) {
        const results = [];
        try {
     ...
     */
    async findJavaExecutable(directory) {
...
exports.SystemJreDetector = SystemJreDetector;
//# sourceMappingURL=SystemJreDetector.js.map