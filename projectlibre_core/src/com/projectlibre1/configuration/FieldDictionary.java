...
//		digester.addObjectCreate("*/fieldDictionary", "com.projectlibre1.configuration.FieldDictionary");
		...
		digester.addSetNext("*/field/select/option","addOption","com.projectlibre1.field.SelectOption"); // add option to select

		digester.addObjectCreate("*/field/range","com.projectlibre1.field.Range"); // create an option when seeing one
		digester.addSetProperties("*/field/range"); // get key and value properties
		digester.addSetNext("*/field/range","setRange","com.projectlibre1.field.Range"); // add option to select

		//non intrusive method to reduce role options, otherwise Select should be modified to depend on a specific object
		digester.addObjectCreate("*/field/filter","com.projectlibre1.field.OptionsFilter"); 
		digester.addSetProperties("*/field/filter"); 
		digester.addSetNext("*/field/filter","setFilter","com.projectlibre1.field.OptionsFilter");
