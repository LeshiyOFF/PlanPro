...
/**
 * Base class for cost and work functors
 */
public abstract class AssignmentFieldOvertimeFunctor extends AssignmentFieldFunctor {
	 ...
	 */
	public AssignmentFieldOvertimeFunctor(
		Assignment assignment,
		WorkCalendar workCalendar,
		ContourBucketIntervalGenerator contourBucketIntervalGenerator, double overtimeUnits) {
	...
	protected double overtimeValue = 0.0;
	...
	/**
	 * @return Returns the overtimeValue.
	 */
	...
	/**
	 * @return Returns the regularValue.
	 */
	...
	public String toString() {
		return " total " + value / (1000*60*60*8) + "  regular " + regularValue / (1000*60*60*8) + "  overtime " + overtimeValue / (1000*60*60*8);
	}
