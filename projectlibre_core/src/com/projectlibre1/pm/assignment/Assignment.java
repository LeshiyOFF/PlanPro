...
import com.projectlibre1.algorithm.InstantIntervalGenerator;
import com.projectlibre1.algorithm.IntervalGeneratorSet;
import com.projectlibre1.algorithm.Merge;
...
import com.projectlibre1.options.AdvancedOption;
...
import com.projectlibre1.pm.assignment.functor.CalculatedValuesFunctor;
import com.projectlibre1.pm.assignment.functor.CostFunctor;
import com.projectlibre1.pm.assignment.functor.DateAtValueFunctor;
import com.projectlibre1.pm.assignment.functor.FixedCostFunctor;
import com.projectlibre1.pm.assignment.functor.PercentAllocFunctor;
import com.projectlibre1.pm.assignment.functor.PersonalContourMaker;
import com.projectlibre1.pm.assignment.functor.PrintValueFunctor;
import com.projectlibre1.pm.assignment.functor.ResourceAvailabilityFunctor;
import com.projectlibre1.pm.assignment.functor.ValueAtInstant;
import com.projectlibre1.pm.assignment.functor.WorkComparator;
import com.projectlibre1.pm.assignment.functor.WorkFunctor;
import com.projectlibre1.pm.assignment.functor.ZeroFunctor;
...
import com.projectlibre1.pm.costing.HasCostRateIndex;
...
//		}
	...
	/* (non-Javadoc)
	 * @see com.projectlibre1.pm.assignment.AssignmentSpecificFields#getWorkContourId()
	 */
	...
	/* (non-Javadoc)
	 * @see com.projectlibre1.pm.assignment.AssignmentSpecificFields#setWorkContourId(int)
	 */
...
//			return 1.0D; // degeneratate case
	...
	/* (non-Javadoc)
	 * @see com.projectlibre1.util.Association#getLeft()
	 */
	...
	/* (non-Javadoc)
	 * @see com.projectlibre1.util.Association#getRight()
	 */
	...
	/* (non-Javadoc)
	 * @see com.projectlibre1.util.Association#testValid()
	 */
	...
	/* (non-Javadoc)
	 * @see com.projectlibre1.util.Association#copyPrincipalFieldsFrom(com.projectlibre1.util.Association)
	 */
	...
	/* (non-Javadoc)
	 * @see com.projectlibre1.association.Association#doUpdateService(java.lang.Object)
	 */
...
//			System.out.println("work before setting non temporal" + DurationFormat.format(w));
	...
	/* (non-Javadoc)
	 * @see com.projectlibre1.pm.assignment.TimeDistributedFields#getBaselineCost(int, com.projectlibre1.field.FieldContext)
	 */
	...
	/* (non-Javadoc)
	 * @see com.projectlibre1.pm.assignment.TimeDistributedFields#getBaselineWork(int, com.projectlibre1.field.FieldContext)
	 */
...
//	}
	...
	/* (non-Javadoc)
	 * @see com.projectlibre1.pm.assignment.Allocation#getMostLoadedAssignmentUnits()
	 */
