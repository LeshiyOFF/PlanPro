...
import com.projectlibre1.grouping.core.hierarchy.BelongsToHierarchy;
import com.projectlibre1.grouping.core.model.NodeModel;
import com.projectlibre1.grouping.core.summaries.DivisionSummaryVisitor;
import com.projectlibre1.grouping.core.summaries.LeafWalker;
...
import com.projectlibre1.pm.costing.EarnedValueMethodType;
import com.projectlibre1.pm.costing.ExpenseType;
import com.projectlibre1.pm.costing.HasExpenseType;
import com.projectlibre1.pm.criticalpath.PredecessorTaskList;
...
import com.projectlibre1.pm.dependency.DependencyFormat;
...
import com.projectlibre1.pm.dependency.HasDependenciesImpl;
...
import com.projectlibre1.pm.scheduling.CanBeLeveled;
...
public abstract class Task implements HasKey, HasNotes, HasCalendar, HasDependencies, Schedule, ScheduleWindow,  Snapshottable, HasTimeDistributedData, HasPriority, CustomFields, BelongsToDocument, BelongsToHierarchy, DataObject, CanBeLeveled,UpdatesFromTimesheet,HasExpenseType,TaskLinkReference {
     ...
     */
    /*# com.projectlibre1.pm.assignment.Assignment lnkAssignment; */
...
//System.out.println(this + " setWbsChildrenNodes " + wbsChildrenNodes);
	...
	/* (non-Javadoc)
	 * @see com.projectlibre1.pm.task.TaskSpecificFields#isParent()
	 */
 ...
 **************************************************************************************/
	...
	/* (non-Javadoc)
	 * @see com.projectlibre1.pm.criticalpath.ScheduleWindow#calcOffsetFrom(long, boolean, boolean)
	 */
 ...
 */	public String getPredecessorOrder() {
		int pos[] = ((com.projectlibre1.pm.criticalpath.CriticalPath)project.getSchedulingAlgorithm()).findTaskPosition(this);
		String result = "" + pos[0];
		if (pos.length ==2)
			result += ", " + pos[1];
		return result;
