...
public class WorkDay extends WorkRange {
	...
	public static WorkDay getNonWorkingDay(){
		if (nonWorkingInstance==null) nonWorkingInstance=new WorkDay(DayType.NON_WORKING);
		return nonWorkingInstance;
	}

	public static WorkDay getDefaultDay(){
		if (defaultInstance==null) defaultInstance=new WorkDay(DayType.DEFAULT);
