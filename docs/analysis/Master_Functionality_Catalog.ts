...
export {
  // Статусы и типы
  ProjectStatus, TaskStatus, ResourceType, DependencyType, ConstraintType,
  ViewType, FieldType, Alignment, DialogType, ButtonType, ValidationType,
  
  // Действия и события
  EventType, ActionCategory,
  
  // Темы и конфигурации
  Theme, LicenseType, UpdateChannel, LogLevel, DatabaseType,
  
  // Экспорт/импорт
  ExportFormat, ImportFormat, MergeStrategy, HTTPMethod,
  
  // Отчеты и шаблоны
  ReportType, TemplateCategory, NotificationType,
  
  // Миграция
  RiskLevel, StepType, ParityStatus
};